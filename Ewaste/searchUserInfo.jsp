...
%>
<h2 align="center"><font><strong>Customer Donation Details</strong></font></h2>
...
String sql ="select * from waste where username='"+user+"'";
...
<td><%=resultSet.getString("wcondition") %></td>
<td><%=resultSet.getString("wweight") %></td>
<td><%=resultSet.getString("wqnt") %></td>
